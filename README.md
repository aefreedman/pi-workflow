...
Pi natively expands the canonical `/plan`, `/work`, `/review`, and `/changelog` prompt templates. Direct slash commands are the sole packaged workflow entry boundary; ordinary prose does not receive package-owned activation or normalization.
